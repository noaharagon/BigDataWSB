...
* What is the advantage of downloading the data set in individual parts (batches) instead of downloading
the one large zip-file containing all observations at once?
* The requirement of using zipping/file compression in the task you have just implemented has conse-
quences for the computational resources needed to run this task. Which hardware component(s) are used more efficiently due to file compression in this task and which ones less efficiently (if any)?
